...
export default function PeriodModal() {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="bg-muted/50 border border-border rounded-2xl max-w-md w-full p-5 shadow-2xl relative animate-in fade-in zoom-in-95">
        ...
        <div className="flex items-center gap-2.5 mb-4">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <kbd className="px-1.5 py-0.5 bg-muted text-zinc-300 rounded border border-input font-mono text-[10px]">
                Alt+F2
              </kbd>
            </div>
        ...
        <form onSubmit={handleApply} className="space-y-4">
          <div className="grid grid-cols-2 gap-3 bg-zinc-950 p-3.5 rounded-xl border border-border">
            <div>
              ...
              <input
                ...
                className="w-full bg-muted/50 border border-input text-foreground px-2.5 py-2 rounded-lg text-xs font-mono outline-none focus:ring-1 focus:ring-blue-500"
                required
              />
            </div>
            <div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-1.5 text-xs">
              <button
                ...
                className="px-2.5 py-1.5 bg-zinc-950 hover:bg-muted text-zinc-300 hover:text-foreground rounded-lg border border-border text-left flex items-center justify-between transition-colors cursor-pointer"
              >

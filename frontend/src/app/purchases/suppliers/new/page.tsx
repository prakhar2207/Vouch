    ...
    <DashboardLayout>
      <div className="max-w-2xl mx-auto space-y-6">
        <div className="flex items-center gap-3 sm:gap-4 border-b border-border pb-4">
          <Link href="/purchases/new" className="text-gray-400 hover:text-white transition-colors p-1">
        ...
        <form onSubmit={handleSave} className="bg-card border border-border rounded-xl shadow-sm p-4 sm:p-6 space-y-5 sm:space-y-6">
          ...
          <div className="flex justify-end pt-4">
            <button type="submit" disabled={saving} className="w-full sm:w-auto justify-center bg-red-600 hover:bg-red-700 text-white px-8 py-3 rounded-lg shadow-lg font-medium transition-colors disabled:opacity-50 cursor-pointer">

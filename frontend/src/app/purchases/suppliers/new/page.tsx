    ...
    <DashboardLayout>
      <div className="max-w-2xl mx-auto space-y-6">
        <div className="flex items-center gap-3 sm:gap-4 border-b border-border pb-4">
          <Link href="/purchases/new" className="text-muted-foreground hover:text-foreground transition-colors p-1">
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path></svg>
          </Link>
          <h1 className="text-2xl sm:text-3xl font-bold">New Supplier</h1>
        </div>
        ...
        <form onSubmit={handleSave} className="bg-card border border-border rounded-xl shadow-sm p-4 sm:p-6 space-y-5 sm:space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            <div className="sm:col-span-2">
              <label className="block text-sm font-medium text-muted-foreground mb-1.5">Supplier / Company Name *</label>
            ...
            <div className="sm:col-span-2 bg-zinc-900/50 border border-border p-4 rounded-xl space-y-2">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-muted/50 border border-input text-foreground p-3 pr-10 rounded-lg focus:ring-2 focus:ring-red-500 outline-none transition-all font-mono"
                />
          ...
          <div className="flex justify-end pt-4">
            <button type="submit" disabled={saving} className="w-full sm:w-auto justify-center bg-red-600 hover:bg-red-700 text-foreground px-8 py-3 rounded-lg shadow-lg font-medium transition-colors disabled:opacity-50 cursor-pointer">

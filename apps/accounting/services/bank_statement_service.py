...
class BankStatementService:
    ...
    IS_DEBIT_REGEX = re.compile(
        ...
        r'\b(?:CASA\s+DEBIT|DEBIT\s+INTEREST|SERVICE\s+CHARGES?|CHGS?|CHARGES?|\bSC\b|COMMISSION|TAX|TDS|GST|SMS\s+CHARGES?)\b|'
        r'\b(?:FOLIO|PROC\s+CHGS?|PROCESSING\s+CHGS?|PROCESSING\s+FEES?|ANNUAL\s+FEE|AMC|INTEREST\s+CAPITALIZED)\b)',
        re.IGNORECASE
    )
